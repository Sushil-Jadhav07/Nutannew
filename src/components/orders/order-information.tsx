			...
			<div className="grid grid-cols-1 xl:grid-cols-[1fr_400px] gap-4 xl:gap-8">
				...
				<div className="bg-white w-full px-5 md:px-8 py-8 rounded-lg space-y-6 border border-border-base">
					...
					<p className="leading-8">
						...
						<Link to="mailto:yourexample@email.com" className={cn(colorMap[selectedColor].link,"hover:underline")}>
							yourexample@email.com
						</Link>{" "}
						or call us at{" "}
						<Link to="tel:(1800)-000-6890" className={cn(colorMap[selectedColor].link,"hover:underline")}>
							(1800)-000-6890
						</Link>
						.
					</p>
