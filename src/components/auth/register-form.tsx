...
export default function RegisterForm({
    ...
    const {handleLogin, handleCloseModal} = useAuthModal();
    ...
    return (
        ...
        >
            ...
            <div className="flex w-full mx-auto overflow-hidden rounded-lg bg-white">
                <div
                    className="w-full py-6 sm:py-10 px-4 sm:px-8 md:px-6 lg:px-8 xl:px-12 rounded-md  flex flex-col justify-center">
